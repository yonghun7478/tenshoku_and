...
interface MessageRepository {
     ...
     */
    suspend fun getMatchingUsers(cursor: String?, limit: Int = 10): Result<CursorResult<MatchingUser>>
     ...
     */
    suspend fun getPreviousChats(cursor: String?, limit: Int = 20): Result<CursorResult<PreviousChat>>
}
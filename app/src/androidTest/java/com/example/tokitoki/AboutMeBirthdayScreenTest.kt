...
class AboutMeBirthdayScreenTest {
    ...
    fun aboutMeBirthdayScreenIsDisplayed() {
        ...
        composeTestRule.onNodeWithTag(TestTags.ABOUT_ME_BIRTHDAY_NEXT_BTN).assertIsDisplayed()
        composeTestRule.onNodeWithTag(TestTags.ABOUT_ME_BIRTHDAY_NEXT_BTN).performClick()
    ...
    fun aboutMeBirthdayScreenNextIsClicked() {
        ...
        composeTestRule.onNodeWithTag(TestTags.ABOUT_ME_BIRTHDAY_NEXT_BTN).isDisplayed()
        composeTestRule.onNodeWithTag(TestTags.ABOUT_ME_BIRTHDAY_NEXT_BTN).performClick()
    }
    ...
    fun aboutMeBirthdayScreenPreviousIsClicked() {
        ...
        composeTestRule.onNodeWithTag(TestTags.ABOUT_ME_BIRTHDAY_PREVIOUS_BTN).isDisplayed()
        composeTestRule.onNodeWithTag(TestTags.ABOUT_ME_BIRTHDAY_PREVIOUS_BTN).performClick()
    }
